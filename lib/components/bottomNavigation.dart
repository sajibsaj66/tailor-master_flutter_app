...
import '../screen.dart/favorite_screen.dart';
import '../screen.dart/home_screen.dart';
import '../screen.dart/settings_screen.dart';
...
class _BottomNavigationState extends State<BottomNavigation> {
  ...
  final _screens = [const HomeScreen(), const FavoriteScreen(), const SettingsScreen()];
